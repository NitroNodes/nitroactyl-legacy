...
export default ({ activity, children }: Props) => {
    ...
    return (
        <div className={'grid grid-cols-10 py-4 border-b-2 rounded border-gray-800 last:rounded-b last:border-0 group'}>
            <div className={'hidden sm:flex sm:col-span-1 items-center justify-center select-none'}>
                <div className={'flex items-center w-10 h-10 rounded-full bg-neutral-800 overflow-hidden'}>
