...
export default function OverviewContainer() {
    return (
        <PageContentBlock title={'Store Overview'} description={'Deploy your servers!'}>
            <div className={'bg-gray-800 bg-opacity-75 text-center w-full rounded-lg h-46'}>
                <p className={'text-3xl mt-4 text-gray-200 text-left ml-10'}>Your servers</p>
            </div>
            <div className={'lg:grid lg:grid-cols-2 gap-4 my-10'}>
                <div className={'bg-gray-800 bg-opacity-75 text-center rounded-lg p-2 px-4 m-2 '}>
